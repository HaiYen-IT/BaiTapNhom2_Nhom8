...
namespace CLIENT
{
    public partial class frmCLIENT : Form
    {
        ...
        void Connect()
        {
            ...
            //Bắt đầu kết nối. Nếu không kết nối được thì hiện thông báo
            try
            {
                client.Connect(IP);
            }
        ...
        void Send()
        {
            ...
            {
                client.Send(Serialize("Client: " + txbMessage.Text));
            }          
        }
        ...
        byte[] Serialize (object obj)
        {
            ...
            //từ stream chuyển các các byte thành dãy rồi chuẩn bị gửi đi
